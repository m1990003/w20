...
namespace cgimin.engine.gui
{
    public class BitmapFont
    {
        ...
        public BitmapFont(string fontFilePath, string bitmapFilePath, Camera cam)
        {
        ...
        public void DrawString(string wString, float xPosition, float yPosition, int r, int g, int b, int a)
        {
            ...
            Matrix4 projection = Matrix4.CreateTranslation(xPosition, yPosition, 0) * cam.GuiProjection;
