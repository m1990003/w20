...
namespace cgimin.engine.gui
{
    public class BitmapGraphic
    {
        ...
        public BitmapGraphic(int textureID, int textureWidth, int textureHeight, int u1, int v1, int width, int height, Camera cam) : base()
        {
        ...
        public void Draw(float positionX, float positionY, float alpha = 1.0f)
        {
            ...
            Matrix4 refMatric = Matrix4.CreateTranslation(positionX, positionY, 0) * cam.GuiProjection;
        ...
        public void DrawXScale(float positionX, float positionY, float alpha = 1.0f, float xScale=1)
        {
            ...
            Matrix4 refMatric = Matrix4.CreateScale(xScale, 1, 1) * Matrix4.CreateTranslation(positionX, positionY, 0) * cam.GuiProjection;
            GL.UniformMatrix4(modelViewProjectionLocation, false, ref refMatric);
